      ...
      <section className="pt-32 pb-20 bg-premium-black text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="md:w-1/2 bg-white p-12 shadow-2xl rounded-sm border border-gray-50">
              <h3 className="text-3xl font-serif mb-8">Request a Valuation</h3>
              <form className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <input type="text" placeholder="First Name" className="w-full bg-gray-50 border border-gray-100 px-4 py-3 outline-none focus:border-premium-gold font-medium placeholder-black" />
                  </div>
                  <div>
                    <input type="text" placeholder="Last Name" className="w-full bg-gray-50 border border-gray-100 px-4 py-3 outline-none focus:border-premium-gold font-medium placeholder-black" />
                  </div>
                </div>
                <div>
                  <input type="email" placeholder="Email Address" className="w-full bg-gray-50 border border-gray-100 px-4 py-3 outline-none focus:border-premium-gold font-medium placeholder-black" />
                </div>
                <div>
                  <input type="text" placeholder="Property Address" className="w-full bg-gray-50 border border-gray-100 px-4 py-3 outline-none focus:border-premium-gold font-medium placeholder-black" />
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <select className="w-full bg-gray-50 border border-gray-100 px-4 py-3 outline-none focus:border-premium-gold font-medium text-black">
                    <option>Property Type</option>
                    <option>Villa</option>
                    <option>Penthouse</option>
                    <option>Estate</option>
                  </select>
                  <input type="text" placeholder="Expected Price" className="w-full bg-gray-50 border border-gray-100 px-4 py-3 outline-none focus:border-premium-gold font-medium placeholder-black" />
                </div>
                <div>
                  <textarea rows={4} placeholder="Additional Details" className="w-full bg-gray-50 border border-gray-100 px-4 py-3 outline-none focus:border-premium-gold resize-none font-medium placeholder-black"></textarea>
                </div>
